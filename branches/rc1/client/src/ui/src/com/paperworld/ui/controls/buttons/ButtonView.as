...
package com.paperworld.ui.controls.buttons
{
	...
	{	
		 ...
		 */
		function onPress(event : MouseEvent = null) : void;

		/**
		 * Handle a rollover event.
		 */
		function onRollOver(event : MouseEvent = null) : void;

		/**
		 * Handle a rollout event.
		 */
		function onRollOut(event : MouseEvent = null) : void;

		/**
		 * Handle a release event.
		 */
		function onRelease(event : MouseEvent = null) : void;
