...
package com.paperworld.framework.loading
{
	...
	import com.paperworld.framework.loading.AbstractPreloader;
	...
	public class Preloader extends AbstractPreloader
	{
		...
		{
			$logger.info( "initialising Preloader" );
			
			super.initialise( target );
		}

		override public function alignAssets(event : Event = null) : void 
		{
			super.alignAssets( event );
		}
	}
}