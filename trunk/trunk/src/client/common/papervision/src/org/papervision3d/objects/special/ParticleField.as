package org.papervision3d.objects.special {
	...
	public class ParticleField extends Particles
	{
		...
		protected var particleSize:Number;
		...
		*/
		public function ParticleField(mat:ParticleMaterial, quantity:int = 200, fieldWidth:Number = 2000, fieldHeight:Number = 2000, fieldDepth:Number = 2000, particleSize:Number = 10)
		{
			super("ParticleField");
