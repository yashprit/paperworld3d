...
public class BoundingSphere implements ICollidable {
	...
	//@Override
	public Boolean hitTest(DisplayObject3D target) 
	{		
		Vector3D direction = Vector3D.sub(target.getPosition(), displayObject.getPosition());
