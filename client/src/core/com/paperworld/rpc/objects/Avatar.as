...
package com.paperworld.rpc.objects 
{
	...
	public class Avatar extends DisplayObject3D 
	{
		...
		public function Avatar(data:Object = null)
		{
			super( );
		...
		public function initialise(data:Object = null):void 
		{
			createAvatar(data);			
			createCharacter();
			createProxy();	
		...
		protected function createAvatar(data:Object = null):void 
		{
			if (data)
			{
				logger.info("Creating avatar " + (data is String) + " | " + data);
				if (data is String)
				{
				...
				logger.info("model: " + avatar.displayObject);
				addChild(avatar.displayObject);
			}
		}
		
		private function modelLoaded(event:Event):void 
		{
			logger.info("model loaded");
			avatar.displayObject.scale = 100;
			logger.info("model loaded " + avatar.displayObject.scale);
		}
		...
		{	
			//logger.info("Synchronsing " + avatar.displayObject + " | " + avatar.displayObject.scale);
